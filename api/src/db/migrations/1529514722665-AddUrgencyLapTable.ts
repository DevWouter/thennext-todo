...
export class AddUrgencyLapTable1529514722665 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("CREATE TABLE `UrgencyLap` (`id` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, `uuid` varchar(255) NOT NULL UNIQUE, `fromDay` int(11) NOT NULL, `urgencyModifier` int(11) NOT NULL, `ownerId` int(11)) ENGINE=InnoDB");
