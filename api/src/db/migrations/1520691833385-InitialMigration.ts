...
export class InitialMigration1520691833385 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `Task` (`id` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, `uuid` varchar(36) NOT NULL UNIQUE, `title` varchar(255) NOT NULL, `description` text NOT NULL, `status` varchar(255) NOT NULL, `createdAt` datetime NOT NULL, `updatedAt` datetime NOT NULL, `completedAt` datetime NOT NULL, `contextId` int(11)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `Context` (`id` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, `uuid` varchar(255) NOT NULL UNIQUE, `name` varchar(255) NOT NULL, `primary` tinyint(4) NOT NULL, `ownerId` int(11)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `DecaySpeed` ADD CONSTRAINT `fk_e3b60fa5172117f92d557c7fbe7` FOREIGN KEY (`accountId`) REFERENCES `Account`(`id`)");
        await queryRunner.query("ALTER TABLE `TagScore` ADD CONSTRAINT `fk_3356dae427362b08358258af064` FOREIGN KEY (`accountId`) REFERENCES `Account`(`id`)");
        await queryRunner.query("ALTER TABLE `ChecklistItem` ADD CONSTRAINT `fk_b04d359139b21e5f8266a774566` FOREIGN KEY (`taskId`) REFERENCES `Task`(`id`)");
        await queryRunner.query("ALTER TABLE `TaskTag` ADD CONSTRAINT `fk_8643032d49a74ce5cc6b5349681` FOREIGN KEY (`taskId`) REFERENCES `Task`(`id`)");
        await queryRunner.query("ALTER TABLE `TaskRelation` ADD CONSTRAINT `fk_e2a00f8da102eb56c2ced224b65` FOREIGN KEY (`sourceTaskId`) REFERENCES `Task`(`id`)");
        await queryRunner.query("ALTER TABLE `TaskRelation` ADD CONSTRAINT `fk_f72068fcf1f30a2bce5cb75e52d` FOREIGN KEY (`targetTaskId`) REFERENCES `Task`(`id`)");
        await queryRunner.query("ALTER TABLE `Task` ADD CONSTRAINT `fk_4282ad8cf47776f942609ab28d7` FOREIGN KEY (`contextId`) REFERENCES `Context`(`id`)");
        await queryRunner.query("ALTER TABLE `Context` ADD CONSTRAINT `fk_d553940d2c5483280ba62913e09` FOREIGN KEY (`ownerId`) REFERENCES `Account`(`id`)");
        await queryRunner.query("ALTER TABLE `Session` ADD CONSTRAINT `fk_00f3bf902525d8c6a4d4cfded33` FOREIGN KEY (`accountId`) REFERENCES `Account`(`id`)");
        await queryRunner.query("ALTER TABLE `AccountSettings` ADD CONSTRAINT `fk_c4cb4d4c7c3a83e2f9c3e4cc395` FOREIGN KEY (`accountId`) REFERENCES `Account`(`id`)");
        await queryRunner.query("ALTER TABLE `TaskEvent` ADD CONSTRAINT `fk_250984a17feb19f8c5a3eba0d47` FOREIGN KEY (`taskId`) REFERENCES `Task`(`id`)");
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `Context` DROP FOREIGN KEY `fk_d553940d2c5483280ba62913e09`");
        await queryRunner.query("ALTER TABLE `Task` DROP FOREIGN KEY `fk_4282ad8cf47776f942609ab28d7`");
